...
<html lang="">
  ...
  <body>
    ...
    <?php
      $id = $_GET["id"];
      $sql = mysqli_query($conexao,"SELECT * FROM turno WHERE id_turno='$id'");
      $exibe = mysqli_fetch_assoc($sql);
    ?>

    <div class="form p-3 px-md-4 mb-3 bg-white border-bottom shadow-lg p3 md-5 rounded">
      <form action="../php/editar_turno.php" method="POST" autocomplete="off">           
        <input  type="hidden" name="id" value="<?php echo $exibe['id_turno'];?>">         
        <input type="text" name="turno" class="form-control" placeholder="Digite a urno" value="<?php echo $exibe['turno'];?>">
