...
<html lang="">
  ...
  <body>
    ...
    <div class="form p-3 px-md-4 mb-3 bg-white border-bottom shadow-lg p3 md-5 rounded">
      <form action="../php/editar_curso.php" method="POST" autocomplete="off">           
        <input  type="hidden" name="id" value="<?php echo $exibe['id_curso'];?>">         
        <input type="text" name="curso" class="form-control" placeholder="Digite a Curso" value="<?php echo $exibe['curso'];?>">
